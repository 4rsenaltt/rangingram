    ...
    private ViewGroup getViewForMessage(int num, boolean applyOffset) {
        ...
        if (messageObject.type == 1 || messageObject.type == 4) {
            if (imageViews.size() > 0) {
                ...
                View view1 = getLayoutInflater().inflate(R.layout.popup_image_layout, null);
                view1.setBackgroundDrawable(ThemeCenter.get().getTheme().getList_selector());
                view.addView(view1);
                view.setTag(2);
            ...
            if (audioViews.size() > 0) {
                ...
                view = new FrameLayoutAnimationListener(this);
                View view1 = getLayoutInflater().inflate(R.layout.popup_audio_layout, null);
                view1.setBackgroundDrawable(ThemeCenter.get().getTheme().getList_selector());
                view.addView(view1);
                view.setTag(3);
            ...
            if (textViews.size() > 0) {
                ...
                view = new FrameLayoutAnimationListener(this);
                View view1 = getLayoutInflater().inflate(R.layout.popup_text_layout, null);
                view1.setBackgroundDrawable(ThemeCenter.get().getTheme().getList_selector());
                view.addView(view1);
                view.setTag(1);
