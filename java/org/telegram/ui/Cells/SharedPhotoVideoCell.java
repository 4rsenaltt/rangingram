...
public class SharedPhotoVideoCell extends FrameLayoutFixed {
    ...
    private class PhotoVideoView extends FrameLayoutFixed {
        ...
        public PhotoVideoView(Context context) {
            ...
            videoInfoContainer.setBackgroundResource(theme.SharedPhotoVideoCell_videoInfoContainer_bg_R);
            ...
            imageView1.setImageResource(theme.SharedPhotoVideoCell_imageView1_img_R);
            ...
            videoTextView.setTextColor(theme.SharedPhotoVideoCell_videoTextView_color);
            ...
            selector.setBackgroundDrawable(ThemeCenter.get().getTheme().getList_selector());
            addView(selector, LayoutHelper.createFrame(LayoutHelper.MATCH_PARENT, LayoutHelper.MATCH_PARENT));

            checkBox = new CheckBox(context, theme.SharedPhotoVideoCell_checkBox_R);
        ...
        public void setChecked(final boolean checked, boolean animated) {
            ...
            if (animated) {
                if (checked) {
                    setBackgroundColor(theme.SharedPhotoVideoCell_bg_color);
                }
                ...
                setBackgroundColor(checked ? theme.SharedPhotoVideoCell_bg_color_2 : 0);
        ...
        if (messageObject != null) {
            ...
            if (messageObject.messageOwner.media instanceof TLRPC.TL_messageMediaVideo && messageObject.messageOwner.media.video != null) {
                ...
                if (messageObject.messageOwner.media.video.thumb != null) {
                    ...
                    photoVideoView.imageView.setImage(null, null, null, ApplicationLoader.applicationContext.getResources().getDrawable(theme.SharedPhotoVideoCell_photoVideoView_img_R), null, location, "b", null, 0);
                } else {
                    photoVideoView.imageView.setImageResource(theme.SharedPhotoVideoCell_photoVideoView_img_2_R);
                }
                ...
                photoVideoView.imageView.setImage(null, null, null, ApplicationLoader.applicationContext.getResources().getDrawable(theme.SharedPhotoVideoCell_photoVideoView_img_3_R), null, photoSize.location, "b", null, 0);
            } else {
                photoVideoView.videoInfoContainer.setVisibility(INVISIBLE);
                photoVideoView.imageView.setImageResource(theme.SharedPhotoVideoCell_photoVideoView_img_4_R);
            }
        } else {
            photoVideoViews[a].clearAnimation();
            photoVideoViews[a].setVisibility(INVISIBLE);
