...
public class ChatMessageCell extends ChatBaseCell {
                ...
                if (webPage.photo != null) {
                        ...
                        if (webPage.site_name != null) {
                            if (webPage.site_name.toLowerCase().equals("instagram") && webPage.type != null && webPage.type.equals("video")) {
                                ...
                                if (igvideoDrawable == null) {
                                    igvideoDrawable = getResources().getDrawable(theme.ChatMessageCell_igvideo_bg_R);
                                }
                            }
                        }
                    }
                    ...
                    if (webPage.type != null && webPage.type.equals("video") && webPage.duration != 0) {
                        if (durationPaint == null) {
                            ...
                            durationPaint.setColor(theme.ChatMessageCell_durationPaint_color);
                        }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (hasLinkPreview) {
            ...
            replyLinePaint.setColor(currentMessageObject.isOutOwner() ? theme.ChatMessageCell_replyLinePaint_color : theme.ChatMessageCell_replyLinePaint_color_2);
            ...
            if (siteNameLayout != null) {
                replyNamePaint.setColor(currentMessageObject.isOutOwner() ? theme.ChatMessageCell_replyNamePaint_color : theme.ChatMessageCell_replyNamePaint_color_2);
                canvas.save();
            ...
            if (titleLayout != null) {
                ...
                replyNamePaint.setColor(theme.ChatMessageCell_replyNamePaint_color_3);
            ...
            if (authorLayout != null) {
                ...
                replyNamePaint.setColor(theme.ChatMessageCell_replyNamePaint_color_4);
                canvas.save();
            ...
            if (descriptionLayout != null) {
                ...
                replyTextPaint.setColor(theme.ChatMessageCell_replyTextPaint_color);
