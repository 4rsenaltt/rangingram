...
public class TextDetailSettingsCell extends FrameLayoutFixed {
    ...
    public TextDetailSettingsCell(Context context) {
        ...
        if (paint == null) {
            paint = new Paint();
            paint.setColor(theme.TextDetailSettingsCell_paint_color);
            paint.setStrokeWidth(1);
        }

        textView = new TextView(context);
        textView.setTextColor(theme.TextDetailSettingsCell_textView_color);
        ...
        valueTextView.setTextColor(theme.TextDetailSettingsCell_valueTextView_color);
