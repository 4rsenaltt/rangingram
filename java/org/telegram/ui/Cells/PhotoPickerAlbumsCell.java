...
public class PhotoPickerAlbumsCell extends FrameLayoutFixed {
    ...
    private class AlbumView extends FrameLayoutFixed {
        ...
        public AlbumView(Context context) {
            ...
            linearLayout.setBackgroundColor(theme.PhotoPickerAlbumsCell_linearLayout_color);
            ...
            nameTextView.setTextColor(theme.PhotoPickerAlbumsCell_nameTextView_color);
            ...
            countTextView.setTextColor(theme.PhotoPickerAlbumsCell_countTextView_color);
        ...
        if (albumEntry != null) {
            ...
            if (albumEntry.coverPhoto != null && albumEntry.coverPhoto.path != null) {
                ...
                if (albumEntry.coverPhoto.isVideo) {
                    albumView.imageView.setImage("vthumb://" + albumEntry.coverPhoto.imageId + ":" + albumEntry.coverPhoto.path, null, getContext().getResources().getDrawable(theme.PhotoPickerAlbumsCell_imageView_img_R));
                } else {
                    albumView.imageView.setImage("thumb://" + albumEntry.coverPhoto.imageId + ":" + albumEntry.coverPhoto.path, null, getContext().getResources().getDrawable(theme.PhotoPickerAlbumsCell_imageView_img_R));
                }
            } else {
                albumView.imageView.setImageResource(theme.PhotoPickerAlbumsCell_imageView_img_R);
            }
