...
public class ProfileSearchCell extends BaseCell {
    ...
    public ProfileSearchCell(Context context) {
        ...
        if (namePaint == null) {
            ...
            namePaint.setColor(theme.ProfileSearchCell_namePaint_color);
            namePaint.setTypeface(AndroidUtilities.getTypeface("fonts/rmedium.ttf"));

            nameEncryptedPaint = new TextPaint(TextPaint.ANTI_ALIAS_FLAG);
            nameEncryptedPaint.setTextSize(AndroidUtilities.dp(17));
            nameEncryptedPaint.setColor(theme.ProfileSearchCell_nameEncryptedPaint_color);
            nameEncryptedPaint.setTypeface(AndroidUtilities.getTypeface("fonts/rmedium.ttf"));

            onlinePaint = new TextPaint(TextPaint.ANTI_ALIAS_FLAG);
            onlinePaint.setTextSize(AndroidUtilities.dp(16));
            onlinePaint.setColor(theme.ProfileSearchCell_onlinePaint_color);

            offlinePaint = new TextPaint(TextPaint.ANTI_ALIAS_FLAG);
            offlinePaint.setTextSize(AndroidUtilities.dp(16));
            offlinePaint.setColor(theme.ProfileSearchCell_offlinePaint_color);

            linePaint = new Paint();
            linePaint.setColor(theme.ProfileSearchCell_linePaint_color);

            countPaint = new TextPaint(TextPaint.ANTI_ALIAS_FLAG);
            countPaint.setTextSize(AndroidUtilities.dp(13));
            countPaint.setColor(theme.ProfileSearchCell_countPaint_color);
            countPaint.setTypeface(AndroidUtilities.getTypeface("fonts/rmedium.ttf"));

            broadcastDrawable = getResources().getDrawable(theme.ProfileSearchCell_broadcastDrawable_R);
            lockDrawable = getResources().getDrawable(theme.ProfileSearchCell_lockDrawable_R);
            groupDrawable = getResources().getDrawable(theme.ProfileSearchCell_groupDrawable_R);
            countDrawable = getResources().getDrawable(theme.ProfileSearchCell_countDrawable_R);
            checkDrawable = getResources().getDrawable(theme.ProfileSearchCell_checkDrawable_R);
        }
