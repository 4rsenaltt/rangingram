...
public class ChatMediaCell extends ChatBaseCell {
    ...
    public ChatMediaCell(Context context) {
        ...
        if (infoPaint == null) {
            ...
            deleteProgressPaint.setColor(theme.ChatMediaCell_deleteProgressPaint_color);
    ...
    protected void onAfterBackgroundDraw(Canvas canvas) {
        ...
        if (currentMessageObject.type == 9) {
            ...
            if (currentMessageObject.isOutOwner()) {
                infoPaint.setColor(theme.ChatMediaCell_infoPaint_color);
                docBackPaint.setColor(theme.ChatMediaCell_docBackPaint_color);
                menuDrawable = ResourceLoader.docMenuOutDrawable;
            } else {
                infoPaint.setColor(theme.ChatMediaCell_infoPaint_color_2);
                docBackPaint.setColor(theme.ChatMediaCell_docBackPaint_color_2);
            ...
            if (!imageDrawn) {
                ...
                if (currentMessageObject.isOutOwner()) {
                    radialProgress.setProgressColor(theme.ChatMediaCell_radialProgress_color);
                } else {
                    radialProgress.setProgressColor(theme.ChatMediaCell_radialProgress_color_2);
                }
            } else {
                if (buttonState == -1) {
                    radialProgress.setHideCurrentDrawable(true);
                }
                radialProgress.setProgressColor(theme.ChatMediaCell_radialProgress_color_3);
            }
        } else {
            radialProgress.setProgressColor(theme.ChatMediaCell_radialProgress_color_4);
        }
        ...
        if (currentMessageObject.type == 1 || currentMessageObject.type == 3) {
            ...
            if (infoLayout != null && (buttonState == 1 || buttonState == 0 || buttonState == 3 || currentMessageObject.isSecretPhoto())) {
                infoPaint.setColor(theme.ChatMediaCell_infoPaint_color_3);
            ...
            if (nameLayout != null) {
                locationAddressPaint.setColor(currentMessageObject.isOutOwner() ? theme.ChatMediaCell_locationAddressPaint_color_1 : theme.ChatMediaCell_locationAddressPaint_color_2);
