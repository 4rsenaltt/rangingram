...
public class SharedLinkCell extends FrameLayout {
    ...
    public SharedLinkCell(Context context) {
        ...
        if (titleTextPaint == null) {
            ...
            titleTextPaint.setColor(theme.SharedLinkCell_titleTextPaint_color);
            ...
            paint = new Paint();
            paint.setColor(theme.SharedLinkCell_paint_color);
            paint.setStrokeWidth(1);

            urlPaint = new Paint();
            urlPaint.setColor(theme.SharedLinkCell_urlPaint_color);
        }
        ...
        checkBox = new CheckBox(context, theme.SharedLinkCell_checkBox_R);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (descriptionLayout != null) {
            descriptionTextPaint.setColor(theme.SharedLinkCell_descriptionTextPaint_color);
            canvas.save();
        ...
        if (descriptionLayout2 != null) {
            descriptionTextPaint.setColor(theme.SharedLinkCell_descriptionTextPaint_color_2);
            canvas.save();
        ...
        if (!linkLayout.isEmpty()) {
            descriptionTextPaint.setColor(theme.SharedLinkCell_descriptionTextPaint_color_3);
            int offset = 0;
            for (int a = 0; a < linkLayout.size(); a++) {
                StaticLayout layout = linkLayout.get(a);
                if (layout.getLineCount() > 0) {
