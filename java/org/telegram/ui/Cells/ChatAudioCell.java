...
public class ChatAudioCell extends ChatBaseCell implements SeekBar.SeekBarDelegate {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (currentMessageObject.isOutOwner()) {
            timePaint.setColor(theme.ChatAudioCell_timePaint_color_1);
            circlePaint.setColor(theme.ChatAudioCell_circlePaint_color_1);
        } else {
            timePaint.setColor(theme.ChatAudioCell_timePaint_color_2);
            circlePaint.setColor(theme.ChatAudioCell_circlePaint_color_2);
        }
