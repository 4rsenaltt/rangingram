...
public class ChatBaseCell extends BaseCell implements MediaController.FileDownloadProgressListener {
    ...
    public ChatBaseCell(Context context) {
        ...
        if (timePaintIn == null) {
            ...
            replyTextPaint.linkColor = theme.ChatBaseCell_replyTextPaint_linkColor;

            replyLinePaint = new Paint();

            urlPaint = new Paint();
            urlPaint.setColor(theme.ChatBaseCell_urlPaint_color);
        }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (currentMessageObject.isOutOwner()) {
            MessageObject.textPaint.setColor(theme.MessageObject_textPaint_color_out_Color);
            ...
            MessageObject.textPaint.setColor(theme.MessageObject_textPaint_color_in_Color);
        ...
        if (drawForwardedName && forwardedNameLayout != null) {
            ...
            if (currentMessageObject.isOutOwner()) {
                forwardNamePaint.setColor(theme.ChatBaseCell_forwardNamePaint_color_1);
                forwardNameX = currentBackgroundDrawable.getBounds().left + AndroidUtilities.dp(10);
            } else {
                forwardNamePaint.setColor(theme.ChatBaseCell_forwardNamePaint_color_2);
                if (media) {
                    forwardNameX = currentBackgroundDrawable.getBounds().left + AndroidUtilities.dp(10);
                } else {
        ...
        if (currentMessageObject.isReply()) {
            if (currentMessageObject.type == 13) {
                replyLinePaint.setColor(theme.ChatBaseCell_replyLinePaint_color);
                replyNamePaint.setColor(theme.ChatBaseCell_replyNamePaint_color);
                replyTextPaint.setColor(theme.ChatBaseCell_replyTextPaint_color);
                int backWidth;
                if (currentMessageObject.isOutOwner()) {
                ...
                if (currentMessageObject.isOutOwner()) {
                    replyLinePaint.setColor(theme.ChatBaseCell_replyLinePaint_color_2);
                    replyNamePaint.setColor(theme.ChatBaseCell_replyNamePaint_color_2);
                    if (currentMessageObject.replyMessageObject != null && currentMessageObject.replyMessageObject.type == 0) {
                        replyTextPaint.setColor(theme.ChatBaseCell_replyTextPaint_color_2);
                    } else {
                        replyTextPaint.setColor(theme.ChatBaseCell_replyTextPaint_color_3);
                    }
                    replyStartX = currentBackgroundDrawable.getBounds().left + AndroidUtilities.dp(11);
                } else {
                    replyLinePaint.setColor(theme.ChatBaseCell_replyLinePaint_color_3);
                    replyNamePaint.setColor(theme.ChatBaseCell_replyNamePaint_color_3);
                    if (currentMessageObject.replyMessageObject != null && currentMessageObject.replyMessageObject.type == 0) {
                        replyTextPaint.setColor(theme.ChatBaseCell_replyTextPaint_color_4);
                    } else {
                        replyTextPaint.setColor(theme.ChatBaseCell_replyTextPaint_color_5);
                    }
