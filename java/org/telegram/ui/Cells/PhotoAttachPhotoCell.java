...
public class PhotoAttachPhotoCell extends FrameLayout {
    ...
    public PhotoAttachPhotoCell(Context context) {
        ...
        checkBox = new CheckBox(context, theme.PhotoAttachPhotoCell_checkBox_R);
        checkBox.setSize(30);
        checkBox.setCheckOffset(AndroidUtilities.dp(1));
        checkBox.setDrawBackground(true);
        checkBox.setColor(theme.PhotoAttachPhotoCell_checkBox_color);
    ...
    public void setPhotoEntry(MediaController.PhotoEntry entry, boolean last) {
        ...
        if (photoEntry.thumbPath != null) {
            imageView.setImage(photoEntry.thumbPath, null, getResources().getDrawable(theme.PhotoAttachPhotoCell_imageView_1_R));
        } else if (photoEntry.path != null) {
            imageView.setOrientation(photoEntry.orientation, true);
            imageView.setImage("thumb://" + photoEntry.imageId + ":" + photoEntry.path, null, getResources().getDrawable(theme.PhotoAttachPhotoCell_imageView_1_R));
        } else {
            imageView.setImageResource(theme.PhotoAttachPhotoCell_imageView_1_R);
        }
