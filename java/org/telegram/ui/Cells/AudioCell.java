...
public class AudioCell extends FrameLayout {
    ...
    public AudioCell(Context context) {
        ...
        if (paint == null) {
            paint = new Paint();
            paint.setColor(theme.AudioCell_paint_color);
            ...
            public void onClick(View v) {
                if (audioEntry != null) {
                    if (MediaController.getInstance().isPlayingAudio(audioEntry.messageObject) && !MediaController.getInstance().isAudioPaused()) {
                        ...
                        playButton.setImageResource(theme.AudioCell_playButton_play_R);
                    } else {
                        ...
                        if (MediaController.getInstance().setPlaylist(arrayList, audioEntry.messageObject)) {
                            playButton.setImageResource(theme.AudioCell_playButton_pause_R);
                            if (delegate != null) {
        ...
        titleTextView.setTextColor(theme.AudioCell_titleTextView_color);
        ...
        genreTextView.setTextColor(theme.AudioCell_genreTextView_color);
        ...
        authorTextView.setTextColor(theme.AudioCell_authorTextView_color);
        ...
        timeTextView.setTextColor(theme.AudioCell_timeTextView_color);
        ...
        checkBox.setColor(theme.AudioCell_checkBox_color);
    ...
    public void setAudio(MediaController.AudioEntry entry, boolean divider, boolean checked) {
        ...
        playButton.setImageResource(MediaController.getInstance().isPlayingAudio(audioEntry.messageObject) && !MediaController.getInstance().isAudioPaused() ? theme.AudioCell_playButton_pause_R : theme.AudioCell_playButton_play_R);
