...
public class LastSeenRadioCell extends FrameLayout {
    ...
    public LastSeenRadioCell(Context context) {
        ...
        if (paint == null) {
            paint = new Paint();
            paint.setColor(theme.LastSeenRadioCell_paint_color);
            paint.setStrokeWidth(1);
        }

        textView = new TextView(context);
        textView.setTextColor(theme.LastSeenRadioCell_textView_color);
        ...
        radioButton.setColor(theme.LastSeenRadioCell_radioButton_color_1, theme.LastSeenRadioCell_radioButton_color_2);
