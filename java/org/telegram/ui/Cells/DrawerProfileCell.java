...
public class DrawerProfileCell extends FrameLayout {
    ...
    public DrawerProfileCell(Context context) {
        super(context);
        setBackgroundColor(theme.DrawerProfileCell_bg_color);
        ...
        nameTextView.setTextColor(theme.DrawerProfileCell_nameTextView_color);
        ...
        phoneTextView.setTextColor(theme.DrawerProfileCell_phoneTextView_color);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (ApplicationLoader.isCustomTheme() && backgroundDrawable != null) {
            phoneTextView.setTextColor(theme.DrawerProfileCell_phoneTextView_color_2);
            ...
            shadowView.setVisibility(INVISIBLE);
            phoneTextView.setTextColor(theme.DrawerProfileCell_phoneTextView_color_3);
            super.onDraw(canvas);
        }
    }
    ...
    public void setUser(TLRPC.User user) {
        ...
        avatarDrawable.setColor(theme.DrawerProfileCell_avatarDrawable_color);
