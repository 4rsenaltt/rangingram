...
public class BotHelpCell extends View {
    ...
    public BotHelpCell(Context context) {
        ...
        textPaint.setColor(theme.BotHelpCell_textPaint_color);
        textPaint.linkColor = theme.BotHelpCell_textPaint_linkColor;

        urlPaint = new Paint();
        urlPaint.setColor(theme.BotHelpCell_urlPaint_color);
    }
