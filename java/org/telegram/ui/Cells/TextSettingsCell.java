...
public class TextSettingsCell extends FrameLayout {
    ...
    public TextSettingsCell(Context context) {
        ...
        if (paint == null) {
            paint = new Paint();
            paint.setColor(theme.TextSettingsCell_paint_color);
            paint.setStrokeWidth(1);
        }

        textView = new TextView(context);
        textView.setTextColor(theme.TextSettingsCell_textView_color);
        ...
        valueTextView.setTextColor(theme.TextSettingsCell_valueTextView_color);
