...
public class RadioButtonCell extends FrameLayoutFixed {
    ...
    public RadioButtonCell(Context context) {
        ...
        if (paint == null) {
            paint = new Paint();
            paint.setColor(theme.RadioButtonCell_paint_color);
            paint.setStrokeWidth(1);
        }

        radioButton = new RadioButton(context);
        radioButton.setSize(AndroidUtilities.dp(20));
        radioButton.setColor(theme.RadioButtonCell_radioButton_color_1, theme.RadioButtonCell_radioButton_color_2);
        ...
        textView.setTextColor(theme.RadioButtonCell_textView_color);
        ...
        valueTextView.setTextColor(theme.RadioButtonCell_valueTextView_color);
