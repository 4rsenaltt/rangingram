...
public class UserCell extends FrameLayout {
    ...
    private int statusColor = theme.UserCell_statusColor_color;
    private int statusOnlineColor = theme.UserCell_statusOnlineColor_color;
    ...
    public UserCell(Context context, int padding) {
        ...
        nameTextView.setTextColor(theme.UserCell_nameTextView_color);
        ...
        checkBox = new CheckBox(context, theme.UserCell_checkBox_R);
