...
public class StickerSetCell extends FrameLayout {
    ...
    public StickerSetCell(Context context) {
        ...
        if (paint == null) {
            paint = new Paint();
            paint.setColor(theme.StickerSetCell_paint_color);
        }

        textView = new TextView(context);
        textView.setTextColor(theme.StickerSetCell_textView_color);
        ...
        valueTextView.setTextColor(theme.StickerSetCell_valueTextView_color);
        ...
        optionsButton.setBackgroundResource(theme.StickerSetCell_optionsButton_R);
