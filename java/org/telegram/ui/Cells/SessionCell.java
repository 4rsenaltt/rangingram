...
public class SessionCell extends FrameLayout {
    ...
    public SessionCell(Context context) {
        ...
        if (paint == null) {
            paint = new Paint();
            paint.setColor(theme.SessionCell_paint_color);
        ...
        nameTextView.setTextColor(theme.SessionCell_nameTextView_color);
        ...
        detailTextView.setTextColor(theme.SessionCell_detailTextView_color);
        ...
        detailExTextView.setTextColor(theme.SessionCell_detailExTextView_color);
    ...
    public void setSession(TLRPC.TL_authorization session, boolean divider) {
        ...
        if ((session.flags & 1) != 0) {
            ...
            onlineTextView.setTextColor(theme.SessionCell_onlineTextView_color);
        } else {
            onlineTextView.setText(LocaleController.stringForMessageListDate(session.date_active));
            onlineTextView.setTextColor(theme.SessionCell_onlineTextView_color_2);
        }
