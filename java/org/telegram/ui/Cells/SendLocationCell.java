...
public class SendLocationCell extends FrameLayout {
    ...
    public SendLocationCell(Context context) {
        ...
        imageView.setImageResource(theme.SendLocationCell_imageView_img_R);
        ...
        titleTextView.setTextColor(theme.SendLocationCell_titleTextView_color);
        ...
        accurateTextView.setTextColor(theme.SendLocationCell_accurateTextView_color);
