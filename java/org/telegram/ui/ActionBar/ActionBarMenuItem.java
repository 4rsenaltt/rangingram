...
public class ActionBarMenuItem extends FrameLayoutFixed {
    ...
    public TextView addSubItem(int id, String text, int icon) {
        ...
        textView.setTextColor(theme.ActionBarMenuItem_textView_color);
        textView.setBackgroundDrawable(ThemeCenter.get().getTheme().getList_selector());
    ...
    public ActionBarMenuItem setIsSearchField(boolean value, boolean needClearButton) {
        ...
        if (value && searchContainer == null) {
            ...
            searchField.setHintTextColor(theme.ActionBarMenuItem_searchField_hint_color);
            searchField.setTextColor(theme.ActionBarMenuItem_searchField_color);
            ...
            try {
                ...
                mCursorDrawableRes.set(searchField, theme.ActionBarMenuItem_mCursorDrawableRes_R);
            } catch (Exception e) {
                //nothing to do
            }
            ...
            if (needClearButton) {
                ...
                clearButton.setImageResource(theme.ActionBarMenuItem_clearButton_R);
