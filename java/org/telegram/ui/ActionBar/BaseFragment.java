    ...
    protected void setParentLayout(ActionBarLayout layout) {
        if (parentLayout != layout) {
            ...
            if (fragmentView != null) {
                ...
                ///fragmentView.setBackgroundColor(0xff33b5e5);
            }
            if (actionBar != null) {
                ViewGroup parent = (ViewGroup) actionBar.getParent();
                if (parent != null) {
            ...
            if (parentLayout != null && actionBar == null) {
                ...
                actionBar.setBackgroundColor(theme.BaseFragment_actionBar_bg_color);
                actionBar.setItemsBackground(theme.BaseFragment_actionBar_R);
            }
        }
    }
