...
public class BottomSheet extends Dialog {
    ...
    private static KharTheme theme = ThemeCenter.get().getTheme();
    ...
    private ColorDrawable backgroundDrawable = new ColorDrawable(theme.BottomSheet_backgroundDrawable_color);
    ...
    private static class BottomSheetCell extends FrameLayout {
        ...
        public BottomSheetCell(Context context, boolean grid) {
            ...
            if (grid) {
                textView.setTextColor(theme.BottomSheet_textView_color_1);
                ...
                textView.setTextColor(theme.BottomSheet_textView_color_2);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        window.setBackgroundDrawableResource(theme.BottomSheet_window_R);
        window.requestFeature(Window.FEATURE_NO_TITLE);
        window.setWindowAnimations(R.style.DialogNoAnimation);

        if (shadowDrawable == null) {
            Rect padding = new Rect();
            shadowDrawable = getContext().getResources().getDrawable(theme.BottomSheet_shadowDrawable_R);
        ...
        ciclePaint.setColor(theme.BottomSheet_ciclePaint_color);
        ...
        if (title != null) {
            ...
            titleView.setTextColor(theme.BottomSheet_titleView_color);
        ...
        if (items != null) {
            if (customView != null) {
                ...
                lineView.setBackgroundColor(theme.BottomSheet_lineView_bg_color);
