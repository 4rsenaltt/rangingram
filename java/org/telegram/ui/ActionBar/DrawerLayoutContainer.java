...
public class DrawerLayoutContainer extends FrameLayout {
    ...
    public DrawerLayoutContainer(Context context) {
        ...
        shadowLeft = getResources().getDrawable(theme.DrawerLayoutContainer_shadowLeft_R);
    }
    ...
    protected boolean drawChild(Canvas canvas, View child, long drawingTime) {
        ...
        if (scrimOpacity > 0 && drawingContent) {
            if (indexOfChild(child) == lastVisibleChild) {
                scrimPaint.setColor((int) (((theme.DrawerLayoutContainer_scrimPaint_color_1 & theme.DrawerLayoutContainer_scrimPaint_color_2) >>> 24) * scrimOpacity) << 24);
