...
public class ResourceLoader {
    ...
    public static void loadRecources(Context context) {
        ...
        if (load) {
            load = false;
            backgroundDrawableIn = theme.ResourceLoader_backgroundDrawableIn;
            backgroundDrawableInSelected = context.getResources().getDrawable(R.drawable.msg_in_selected);
            backgroundDrawableOut = theme.ResourceLoader_backgroundDrawableOut;
            ...
            checkDrawable = theme.ResourceLoader_checkDrawable;
            halfCheckDrawable = theme.ResourceLoader_halfCheckDrawable;
