...
public class MessageObject {
    ...
    public MessageObject(TLRPC.Message message, AbstractMap<Integer, TLRPC.User> users, boolean generateLayout) {
        if (textPaint == null) {
            ...
            textPaint.setColor(theme.MessageObject_textPaint_color);
            textPaint.linkColor = theme.MessageObject_textPaint_link_color;

            if(theme.MessageObject_textPaint_typeface != null)
            textPaint.setTypeface(theme.MessageObject_textPaint_typeface);
    ...
    private void generateLayout() {
        ...
        /*
        if(isOut()){
            textPaint.setColor(theme.MessageObject_textPaint_color_out_Color);
        }else {
            textPaint.setColor(theme.MessageObject_textPaint_color_in_Color);
        }*/
